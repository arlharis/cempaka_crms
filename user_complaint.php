...
<?php include "header.php"; ?>
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i><strong> Complaint Section</strong></div>
       <div class="container">
        ...
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-black bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">My Complaint</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="user_all_complaint.php">
         ...
         <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-black bg-danger o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Lodge Complaint</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="user_add_complaint.php">
