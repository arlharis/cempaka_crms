        ...
        <div class="col-xl-4 col-sm-6 mb-3">
          <div class="card text-black bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><strong>Fellow List</strong></div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="fellow_list.php">
         ...
         <div class="col-xl-4 col-sm-6 mb-3">
          <div class="card text-black bg-secondary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><strong>Add Fellow</strong></div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="add_fellow.php">
        ...
        <div class="col-xl-4 col-sm-6 mb-3">
          <div class="card text-black bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><strong>On-Duty Fellow List</strong></div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="on_duty_fellow_list.php">
              <span class="float-left">To the list</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
