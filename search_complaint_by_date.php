...
<div class="content-wrapper">
  ...
  <body bgcolor="#FFFFFF">
<form name="carian" action="search_by_date.php" method="post">
<table align="center" width=80% width="100%" cellspacing="4" cellpadding="4" border="3">
    <tr>
        <td colspan="2" align="center"><b>SEARCH COMPLAINT BASED ON DATE</b><br><br>
       
       <p align="left" valign="top" width="50%"><center> Choose a date &nbsp;&nbsp; <input type="date" value="" name="date" size="20">&nbsp;&nbsp; TO &nbsp;&nbsp;  <input type="date" value="" name="date2" size="20"></p></center><br>
