...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once('includes/_class/exception.class.php');
    require_once('includes/_class/locale.class.php');
    require_once('includes/_class/myPdf.class.php');
    require_once('includes/_class/parsingHtml.class.php');
    require_once('includes/_class/parsingCss.class.php');
