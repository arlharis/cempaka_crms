<?php
	...
	if (isset($_POST['processform_type'])) { $processform_type = $_POST['processform_type']; } else { $processform_type = "javascript"; }
	...
	else
	{
		...
		if (isset($_POST['parameters'])) { $parameters = $_POST['parameters']; } else { $parameters = ""; }
		$fieldname = array();
		$fields = array();
		//echo $parameters;	
		//include "../functions.php";
