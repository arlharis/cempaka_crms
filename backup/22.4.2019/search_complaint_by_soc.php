...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">By Social</li>
      </ol>
      <!-- Icon Cards-->
  ...
  <body bgcolor="#FFFFFF">
<form name="carian" action="search_by_sdate.php" method="post">
<table align="center" width=80% width="100%" cellspacing="4" cellpadding="4" border="3">
    <tr>
        <td colspan="2" align="center"><b>SEARCH FOR SOCIAL COMPLAINT</b><br><br>
