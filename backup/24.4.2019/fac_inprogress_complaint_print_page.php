 ...
 */
    ...
    // get the HTML
    ob_start();
    include(dirname(__FILE__).'/fac_inprogress_complaint_print_page.inc.php');
	//include(dirname(__FILE__).'/ticket-print.php');
    $content = ob_get_clean();
	
	$datenow = date("dmY");
	$printname = "Facilities Report [In Process]".$datenow;
    ...
    try
    {
        ...
        $html2pdf = new HTML2PDF('L', array($width_in_mm,$height_in_mm), 'en', true, 'UTF-8',  array(5, 3, 0, 0));
