     ...
     <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
         ...
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="QR_emergency_call.php">
            <span class="nav-link-text"><button class="id"><link rel="stylesheet" type="text/css" href="includes/css/emergency.css">Emergency button</button></span>
          </a>
        </li>
      </ul>
    </div>
