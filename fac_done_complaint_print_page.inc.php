...
<LINK href="includes/css/interface2.css" rel="stylesheet" type="text/css"> 
	...
	<?php 
		...
		*/
		...
		$qry = "SELECT * , DATE_FORMAT(dated,'%d-%m-%Y') AS dated FROM complaint WHERE complaint_type = 'Facilities' AND action = 'Done' AND status = 1 ORDER BY  dated DESC "; 
  ...
  ?>
    ...
    <page backtop="48mm" backbottom="20mm" backleft="0mm" backright="0mm" style="font-size: 9pt;">
    <page_header>
   ...
   <table border="0" id="print_header" style=" font-weight:bolder; font-size:15px; table-layout:fixed; 
      ...
      <tr>
        ...
        <td align="center" style="width:59%; font-weight:bolder; font-size:13px;">
            <p><strong>FACILITIES COMPLAINT REPORT</strong></p>
            <!-- --><p><strong>[SETTLED COMPLAINT]</strong></p> 
        </td>
