...
<br>
<form name="rekod" action="update_user_process.php?id=<?php echo $getid ?>" method="post">
<?php
...
<tr>
  ...
  <tr>
      <td colspan=2>
      <p align=center>
      <input type='submit' value="SUBMIT" name="submit" style=background:#5A76F5></input>
      <input type='submit' value="CANCEL" name="cancel" style=background:#F90F0F></input>
