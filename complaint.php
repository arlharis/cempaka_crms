        ...
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-black bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Complaint List</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="all_complaint.php">
         ...
         <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-black bg-danger o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Add Complaint</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="add_complaint.php">
